...
import { MessageCircle, Phone, Video, Heart, Users, Star, Clock, Info } from 'lucide-react';
  ...
  const services = [
    {
      ...
      price: '25k/hari',
      description: 'Chat sepuasnya selama 1 hari penuh',
      color: 'bg-blue-500',
      features: ['Unlimited messages', 'Emoji & stickers', 'Photo sharing']
    },
    {
      id: 'call',
      name: 'Voice Call',
